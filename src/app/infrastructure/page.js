...
const FACILITIES = [
  {
    ...
    light: "#E1F5FE",
    accent: "#0288D1",
    stat: "Comfort Learning",
    tag: "Smart Learning",
    desc: "Air-conditioned classrooms designed to keep children comfortable, focused, and engaged throughout the day.",
    features: ["Fully AC", "Child-Friendly Setup", "Bright & Clean", "Comfort Seating"],
  ...
  },
  {
    ...
    tag: "Discipline & Strength",
    desc: "Professional taekwondo sessions that build confidence, discipline, and physical fitness in young learners.",
    features: ["Certified Trainer", "Self-Defense", "Fitness", "Confidence Boost"],
    shape: "col-span-1 row-span-1",
  },
  {
    id: "dance",
    ...
    stat: "Fun Learning",
    tag: "Express & Move",
    desc: "Energetic dance sessions that help children express themselves, improve coordination, and enjoy movement.",
    features: ["Creative Movement", "Music Fun", "Stage Confidence", "Rhythm Skills"],
    shape: "col-span-1 row-span-1",
  },
  {
    id: "chess",
    ...
    light: "#E8F5E9",
    accent: "#2E7D32",
    stat: "Brain Development",
    tag: "Think Smart",
    desc: "Basic chess training to improve focus, problem-solving, and logical thinking from an early age.",
    features: ["Strategy Skills", "Focus Building", "Logical Thinking", "Fun Learning"],
    shape: "col-span-1 row-span-1",
  },
  {
    id: "games",
    name: "Fun Games & Activities",
    emoji: "🎯",
    color: "#CE93D8",
    light: "#F3E5F5",
    accent: "#7B1FA2",
    stat: "Daily Play",
    tag: "Play & Learn",
    desc: "Engaging indoor and outdoor games that promote teamwork, creativity, and physical activity.",
    features: ["Group Games", "Outdoor Play", "Team Building", "Active Fun"],
    shape: "col-span-1 row-span-1",
  },
  {
    id: "teachers",
    name: "Interactive Teachers",
    emoji: "👩‍🏫",
    color: "#FFAB76",
    light: "#FFF3E0",
    accent: "#E65100",
    stat: "Experienced Staff",
    tag: "Caring Mentors",
    desc: "Friendly and engaging teachers who focus on interactive learning and personal attention for every child.",
    features: ["Activity-Based Learning", "Personal Attention", "Friendly Approach", "Child-Centered"],
    shape: "col-span-1 row-span-1",
  },
];
